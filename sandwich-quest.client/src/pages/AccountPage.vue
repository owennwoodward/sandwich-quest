...
<button class="btn btn-success" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Edit Account</button>
...
<div class="offcanvas offcanvas-top  bg-dark" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
  <div class="offcanvas-header">
    ...
    <i class=" mdi mdi-window-close btn-dark bg-dark text-reset selectable" data-bs-dismiss="offcanvas" aria-label="Close"></i>
  </div>
  <div class="offcanvas-body">
      ...
      <form class="d-flex flex-column align-items-center" action="" @submit.prevent="editAccount">
        ...
        <button  data-bs-dismiss="offcanvas" aria-label="Save" class="btn btn-primary">Save</button>
        </div>
      </form>
  </div>
</div>
